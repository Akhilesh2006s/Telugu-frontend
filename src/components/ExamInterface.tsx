...
const ExamInterface = ({ 
  ...
  const completeExam = () => {
    ...
    if (examType === "voice" || examType === "mixed") {
      ...
      score += Object.keys(voiceRecordings).length; // Placeholder
    }
  ...
  const handleVoiceRecording = (questionId: string, recording: VoiceRecording) => {
          ...
          <Card key={question.id}>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Badge variant={voiceRecordings[question.id] ? "default" : "secondary"}>
                  {voiceRecordings[question.id] ? "Recorded" : "Pending"}
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <VoiceRecording
                activityTitle={question.title}
                teluguTitle={question.teluguTitle}
                maxRecordings={3}
              />
            </CardContent>
          </Card>
